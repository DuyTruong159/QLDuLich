<%-- 
    Document   : aboutus
    Created on : Aug 2, 2021, 8:17:05 PM
    Author     : duytruong
--%>
                        ...
                        <div class="row">
                                <div class="col-md-6">
                                        <div class="team wow fadeInRight">
                                                <figure class="team-image">
                                                        <img src="assert/dummy/person-team-1.jpg" alt="">
                                                </figure>
                                        ...
                                        <div class="team wow fadeInRight">
                                                <figure class="team-image">
                                                        <img src="assert/dummy/person-team-2.jpg" alt="">
                                                </figure>
                                ...
                                <div class="col-md-6">
                                        <div class="team wow fadeInRight" data-wow-delay=".4s">
                                                <figure class="team-image">
                                                        <img src="assert/dummy/person-team-3.jpg" alt="">
                                                </figure>
                                        ...
                                        <div class="team wow fadeInRight" data-wow-delay=".4s">
                                                <figure class="team-image">
                                                        <img src="assert/dummy/person-team-4.jpg" alt="">
                                                </figure>
