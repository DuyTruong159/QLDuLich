<%-- 
    Document   : addStaff
    Created on : Aug 30, 2021, 12:49:55 PM
    Author     : duytruong
--%>
...
<div class="pd-20 card-box mb-30">
    ...
    <c:url value="/admin/add_staff" var="action" />
    <form:form method="post" action="${action}" modelAttribute="user" enctype="multipart/form-data">
        <form:errors path="*" cssClass="alert alert-danger" element="div"/>
            ...
            <div class="form-group">
                    ...
                    <form:input type="password" id="confirmPassword" path="confirmPassword" cssClass="form-control"/>
            </div>
            <div class="form-group">
